  ...
  return(
    <main className="min-h-screen flex flex-col items-center transition-colors duration-500">
      ...
      <section className="flex flex-col items-center justify-center flex-1 text-center pt-24 px-4">
        ...
        <a href="#cv" className="mt-6 inline-block bg-blue-600 text-white px-6 py-3 rounded-lg shadow hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-400 transition-colors">
          Voir mon CV 📄
        </a>
      </section>
      ...
      <section id="cv" className="w-full bg-white dark:bg-gray-800 py-12 px-4 text-center transition-colors duration-500">
        ...
        <a href={pdfUrl} download target="_blank" className="mt-6 inline-block text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-semibold transition-colors">
